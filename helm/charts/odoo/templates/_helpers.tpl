...
{{/*
Selector labels for cron
*/}}
{{- define "odoo.cron.selectorLabels" -}}
app.kubernetes.io/name: {{ include "odoo.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
...
{{/*
Selector labels for hatch
*/}}
{{- define "odoo.hatch.selectorLabels" -}}
app.kubernetes.io/name: {{ include "odoo.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
app.kubernetes.io/component: hatch
{{- end }}
...
{{/*
Generate a TLS secret name from a host, replacing dots with dashes and appending '-tls'
*/}}
{{- define "odoo.tlsSecretName" -}}
{{- .host | replace "." "-" | printf "%s-tls" -}}
{{- end }}
