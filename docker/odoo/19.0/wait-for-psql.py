...
if __name__ == '__main__':
    ...
    db_host = config_options.get('db_host') or args.db_host or os.environ.get('DB_HOST')
    db_port = config_options.get('db_port') or args.db_port or os.environ.get('DB_PORT')
    db_user = config_options.get('db_user') or args.db_user or os.environ.get('DB_USER')
    db_password = config_options.get('db_password') or args.db_password or os.environ.get('DB_PASSWORD')
